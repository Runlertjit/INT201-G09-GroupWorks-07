...
products.forEach(product => { //ใช้ for-each ในการเข้าถึง element ทุกตัวใน array ที่ import มา และสร้าง div ของตัวเอง
    if (num == 0) {
    ...
    innerDiv.setAttribute("class", "sProduct col bg-body card rounded p-2 bd-highlight mh-100 px-md-5 py-md-5 mx-md-5 my-md-5");
